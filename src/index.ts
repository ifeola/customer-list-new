...
class CustomerObj {
  ...
  constructor(name: string, email: string, number: string, date: string, company: string, status: string) {
    this.name = name
    this.email = email
    this.number = number
    this.date = date;
...
class UI{
  ...
  static showActions(event: EventTarget): void {
  ...
  static checkCustomer(event: EventTarget): void {
  ...
  static deleteCustomer(event: EventTarget): void {
    const target = event as HTMLButtonElement;
  ...
  static duplicateCustomer(event: EventTarget): void {
    const target = event as HTMLButtonElement;
  ...
  static addCustomer(name:string, email:string, company:string, date: string, number:string, status: string){
